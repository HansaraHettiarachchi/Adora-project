...
Project Overview
This is a modern e-commerce frontend built with React, TypeScript, and Vite. It features a clean UI, fast performance, and modular code structure. The app uses React Router for navigation, Bootstrap for styling, and integrates with a backend via Axios.
...
Branches - main , fornt-end , back-end
